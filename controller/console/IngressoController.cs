...
public class IngressoController
{
    ...
    public void CriarIngresso(SessaoController sessaocontroller, SalaController salacontroller)
    {
    ...
    public void CancelarIngresso(SessaoController sessaocontroller)


    {
        ListarIngressos();
        Console.Write("Digite o ID do ingresso a ser cancelado: ");
        int id = int.Parse(Console.ReadLine() ?? "0");


        Ingresso? ingressoremover = ingressos.FirstOrDefault(i => i.Id == id);
